...
def create_parser():
    ...
    parser.add_argument('--exp_name', type=str, default = 'exp_84_oldhouse_uniform_wo_masks')
    
    # strategy settings
    parser.add_argument('--global_loss', type=bool, default = False)
    parser.add_argument('--texturize', type=bool, default = False)
    ...
    parser.add_argument('--budgets', type=list, default=[9, 9, 49, 64])  # abstracted [9, 9, 49]                # realistic  [9, 9, 49, 64]
    parser.add_argument('--iter_steps', type=list, default=[300, 300, 300, 300]) # [300, 300, 300]

    parser.add_argument('--number_natural_patches', type=int, default=[30])  # [25, 30, 25] # [30, 50, 60] WE DID NOT DEFINE THIS IN THE PAPER 

    # misc settings 
    parser.add_argument('--upsample', type=bool, default = False)
    parser.add_argument('--aspect_ratio_downsample', type=float, default=3)
    parser.add_argument('--image_path', type=str, default = '/home/manuelladron/projects/npp/stroke_opt_main/images/oldhouse.jpg') # /home/manuelladron/projects/npp/sigg-asia-imgs/siggraph_asia/landscapes/dalle_1.png
