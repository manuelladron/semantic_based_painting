...
def create_parser():
    ...
    parser.add_argument('--exp_name', type=str, default = 'exp_116')
    ...
    parser.add_argument('--budgets', type=list, default=[9, 9, 36, 49])  # abstracted [9, 9, 49]                # realistic  [9, 9, 49, 64]
    parser.add_argument('--iter_steps', type=list, default=[350, 300, 300, 300]) # [300, 300, 300]
...
if __name__ == '__main__':
    ...
    args.exp_name = args.exp_name + f'_{basename}_mask_{usemask}_mode_{mode}_start_natural_{args.start_natural_level}_filter_{args.filter_strokes}_brush_sizes_{args.brush_sizes}_budgets_{args.budgets}'
    
    # Make dir to save images 
    args.save_dir = os.path.join(args.save_dir, args.exp_name, basename)
